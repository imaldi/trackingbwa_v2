...
class HistoryBulkScan extends StatefulWidget {

  @override
  _HistoryBulkScanState createState() => new _HistoryBulkScanState();
}

class _HistoryBulkScanState extends State<HistoryBulkScan> {
  var tanggal ;
